...
$user_info = $_SESSION['user_info'];
	...
	print "<div class='intro'>";
		print "<p><b>Appreciate your suggestions</b></p>";
		print "</div>";
		print "<div class='intro'>";
		$external_info = $_SESSION['external_info'];
	...
	<div class="intro">
	<p>
		Thank you very much for your participation, Would you like to submit your opinions? 
	</p>
	</div>	
	<form id = 'submit_sessions' method='post'>
		<input type ='hidden' name= 'submit_sessions' value='Submitpage!'>
	</form>
